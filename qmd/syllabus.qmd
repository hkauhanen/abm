...
| 21.5.		| [Programming best practices](lectures/bestpractices.qmd) | (keep thinking about your project) | @Smaldino2023, chapter 10 |
| ~~28.5.~~ | *No lecture (Vorlesungsfreie Zeit)*					| | |
| ~~4.6.~~  |	*No lecture (Vertiefungswoche)*				| | |
| 11.6.		| [Social networks](lectures/networks.qmd) | [Degree and clustering](homework/clustering.qmd) | @Smaldino2023, chapter 9 |
| ~~18.6.~~		| *Cancelled due to sickness*	| | |
| 25.6.		| [Simulations on social networks](lectures/network-simulations.qmd) | [Ensembles and statistics](homework/ensembles.qmd) | |
| 2.7.		| Presentations 1					| | |
| 9.7.		| Presentations 2				| | |
| 16.7.		| Exam					| | |
