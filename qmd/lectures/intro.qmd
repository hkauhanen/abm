...
| Rule | Cell | Surrounded by | Result |
|------|------|---------------|--------|
...
- A simple model of the emergence of collective behaviour, flocking in birds
...
- SIR (susceptible-infected-recovered) models are used to model epidemics, e.g. the spread of viruses
