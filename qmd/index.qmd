...
These materials have benefitted immensely from the labours of the open source software movement. Thanks are due to the developers of [Julia](https://julialang.org) as well as to developers and contributors of the [Agents.jl](https://juliadynamics.github.io/Agents.jl) framework. [Quarto](https://quarto.org) made typesetting the materials a breeze -- and fun.
:::
